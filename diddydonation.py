...
class CheckOutPage(BaseHandler):
    ...
    def get(self):
        ...
        for k in link_list:
            ...
            outtext += '<div style="float:left;margin: 0 0 0 30px"><span class="showClosed">Checkout closed</span> - amount too low (<span class="moreInfo"><a href="http://diddydonation.bitmortar.com/faq#amounttoolow">learn more</a></span>)</div>'
            #else:
